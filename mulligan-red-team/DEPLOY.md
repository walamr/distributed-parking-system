...
This directory is an older pre-hardening red-team package snapshot. It is not the current Stage 2 deployment guide. Use repository-root `DEPLOY.md` and the rebuilt `RedTeamMaterials.zip`.
